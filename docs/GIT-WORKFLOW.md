...
The MUXI CLI uses a **three-branch workflow** for development, testing, and releases.
...
- **Actions:** Lint, test, coverage check

### RC (`rc.yml`)
- **Trigger:** Push to `rc`
- **Actions:** Build all platforms, run tests, upload artifacts

### Release (`release.yml`)
- **Trigger:** Push to `main`
- **Actions:** 
  - Calculate version (ScalVer)
