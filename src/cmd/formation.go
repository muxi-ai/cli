...
func init() {
	...
	serverDeleteCmd.Flags().Bool("force", false, "Skip confirmation prompt")
	...
	serverStopCmd.Flags().Bool("force", false, "Skip confirmation prompt")
	serverStartCmd.Flags().String("profile", "", "Server profile to use")
	serverRestartCmd.Flags().String("profile", "", "Server profile to use")
	serverRestartCmd.Flags().Bool("force", false, "Skip confirmation prompt")
	serverRollbackCmd.Flags().String("profile", "", "Server profile to use")
	serverRollbackCmd.Flags().Bool("force", false, "Skip confirmation prompt")
